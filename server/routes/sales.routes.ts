...
import { getDb, persistDatabase, withTransaction } from '../database';
...
router.post('/', authMiddleware, (req: Request, res: Response) => {
  ...
  withTransaction(() => {
    ...
    db.run(
      ...
      [saleId, code, now, clientId || null, clientName || null, subtotal, totalCommissions, totalFees, totalPayable, user.userId, user.name, cashSessionId, user.terminalId]
    );
...
router.put('/:id', authMiddleware, (req: Request, res: Response) => {
  ...
  withTransaction(() => {
    ...
    // Remove old cash session amounts and add new ones
    if (cashSessionId) {
    ...
    db.run(
      ...
      [clientId || null, clientName || null, subtotal, totalCommissions, totalFees, totalPayable, id]
    );
